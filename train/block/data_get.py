...
class OD(object):
    ...
    def _load(self):
        ...
        class_list=[]
        class_dict = {}
        start=0 if not args.model_test else self.boundary
        ...
        return self._divide()
    def _divide(self):
        self.dict_dataset['img_train'] = self.list_img[0:self.boundary]
        self.dict_dataset['img_test'] = self.list_img[self.boundary:]
        self.dict_dataset['label_train'] = self.list_label[0:self.boundary]
        self.dict_dataset['label_test'] = self.list_label[self.boundary:]
        return self.dict_dataset
