...
parser.add_argument('--OD_iou_threshold', default=0.5, type=float, help='|OD指标计算的iou阈值，不影响训练，基准为0.5|')
...
parser.add_argument('--OD_plot_confidence', default=0.9, type=float, help='|OD非极大值抑制前先根据置信度筛选框|')
