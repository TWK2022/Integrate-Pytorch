...
parser.add_argument('--OD_confidence_threshold', default=0.8, type=float, help='||OD指标计算的置信度阈值，不影响训练，基准为0.5||')
...
parser.add_argument('--OD_plot_screen', default=500, type=int, help='|OD非极大值抑制前根据置信度排名筛选出的框数|')
